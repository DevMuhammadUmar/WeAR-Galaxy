...
// general images
  ...
  static String pfp = "$imagesPath/pfp.jpg";
  ...
  static String wg = "$bagImagesPath/wg.jpg";
  static String wgb = "$bagImagesPath/wgb.png";
  static String wgw = "$bagImagesPath/wgw.png";
